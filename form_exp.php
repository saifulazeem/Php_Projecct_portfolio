...
<center>
	<div class="Contact">
		...
		<h1 style="float: left;">Experience Details:</h1>
			<br>
		<br>
...
$query=$con->prepare("INSERT INTO experience(title,discription,from_date,to_date,author) VALUES(?,?,?,?,?)");
$query->bind_param("sssss",$title,$info,$from_date,$to_date,$author);
$query->execute();
echo "Experience Enter Sucessfully";
